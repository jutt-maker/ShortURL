...
clear
printf "\e[0m\n"
printf "\e[0m\e[1;91m    _____ _                _     _    _ _____  _      \e[0m\n"
printf "\e[0m\e[1;91m   / ____| |              | |   | |  | |  __ \| |     \e[0m\n"
printf "\e[0m\e[1;91m  | (___ | |__   ___  _ __| |_  | |  | | |__) | |     \e[0m\n"
printf "\e[0m\e[1;91m   \___ \|  _ \ / _ \|  __| __| | |  | |  _  /| |     \e[0m\n"
printf "\e[0m\e[1;91m   ____) | | | | (_) | |  | |_  | |__| | | \ \| |____ \e[0m\n"
printf "\e[0m\e[1;91m  |_____/|_| |_|\___/|_|  \___|  \____/|_|  \_\______|\e[0m\n"
printf "\e[0m\n"
printf "\e[0m\e[1;92m        Created By jutt-maker \e[0m\e[1;91m( \e[0m\e[1;92mZainJutt \e[0m\e[1;91m)\e[0m\n"
printf "\e[0m\n"
...
cp -f url /data/data/com.termux/files/usr/bin/ShortUrl
echo 'termux-open-url https://github.com/HackWeiser360/' > /data/data/com.termux/files/usr/bin/HackWeiser360
echo 'termux-open-url https://github.com/HackWeiser360/' > /data/data/com.termux/files/usr/bin/HackWeiser360
echo 'termux-open-url https://www.instagram.com/madmax4708/' > /data/data/com.termux/files/usr/bin/instagram
echo 'termux-open-url https://www.instagram.com/madmax4708/' > /data/data/com.termux/files/usr/bin/Instagram
chmod +x /data/data/com.termux/files/usr/bin/HackWeiser360
chmod +x /data/data/com.termux/files/usr/bin/HackWeiser360
